        ...
        <div class="py-2 px-md-5 px-3 movie-detail-menu rounded">
            <div class="d-flex align-items-center gap-2">
                  <ul class="nav" role="tablist" id="detail-tab">
                    ...
                    <li class="nav-item px-3 underline-white" role="presentation">
                      <a class="text-white movie-related-links" style="font-weight: 600;font-size:18px;line-height:39px;" id="simple-tab-1" data-bs-toggle="tab" href="#simple-tabpanel-1" role="tab" aria-controls="simple-tabpanel-1" aria-selected="false">Download</a>
                    </li>
                  </ul>
            </div>
        </div>
