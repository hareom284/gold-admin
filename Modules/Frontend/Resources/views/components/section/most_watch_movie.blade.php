...
<div class="top-ten-block">
    ...
    <h5 class="main-title text-capitalize mb-0">{{__('frontend.most_watch')}}</h5>
    </div>
    <div class="card-style-slider {{ count($most_watch) <= 6 ? 'slide-data-less' : '' }}">
        <div class="slick-general slick-general-most-watch  iq-top-ten-block-slider" data-items="6.5" data-items-desktop="5.5" data-items-laptop="4.5" data-items-tab="3.5" data-items-mobile-sm="3.5"
            ...
            @foreach ( $most_watch as $index => $data)
