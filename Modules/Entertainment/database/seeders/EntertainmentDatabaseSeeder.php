    ...
    public function run()
    {
        ...
        if (env('IS_DUMMY_DATA')) {
            foreach ($entertainments as $entertainmentData) {
                ...
                $entertainment = Entertainment::create(Arr::except($entertainmentData, ['thumbnail_url', 'poster_url', 'genre_id','tag_id', 'actors', 'directors','countries', 'stream_content']));
                ...
                foreach ($entertainmentData['tag_id'] as $tagId) {
                    EntertainmentTagMapping::create([
                        'entertainment_id' => $entertainment->id,
                        'tag_id' => $tagId,
                    ]);
                }
